 ...
 * 罗马数字的简单实现， Java 语言
 */
public class A0519RomanNumeral {

    private static final String NUMERAL_MUST_BE_POSITIVE =
            "Value of A0519RomanNumeral must be positive.";
    private static final String NUMERAL_MUST_BE_3999_OR_LESS =
            "Value of A0519RomanNumeral must be 3999 or less.";
    ...
    public A0519RomanNumeral(int arabic) {
        if (arabic < 1)
    ...
    public A0519RomanNumeral(String roman) {
        if (roman.length() == 0)
